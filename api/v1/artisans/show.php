...
try {
    ...
    echo json_encode([
        ...
        'data' => [
            ...
            'experienceYears' => (int) ($artisan['experience_years'] ?? 0),
            ...
            'image' => 'https://via.placeholder.com/300x300/C2652A/FFFFFF?text=Artisan',
            'skills' => [],
            'services' => [],
